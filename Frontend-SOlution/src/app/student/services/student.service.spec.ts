...
describe("StudentService", () => {
  ...
  describe("functional", () => {
    ...
    it("should retrieve all students", () => {
      ...
      service.getAllStudents().subscribe((response: any) => {
    ...
    it("should retrieve a student by ID", () => {
      ...
      service.getStudentById(studentId).subscribe((data: any) => {
    ...
    it("should create a new student", () => {
      ...
      service.createStudent(newStudent).subscribe((response: any) => {
    ...
    it("should update an existing student", () => {
      ...
      service.updateStudent(updatedStudent).subscribe((response: any) => {
    ...
    it("should delete an existing student", () => {
      ...
      service.deleteStudent(studentId).subscribe((response: any) => {
    ...
    it("should search for students", () => {
      ...
      service.searchStudents(searchTerm).subscribe((response: any) => {
