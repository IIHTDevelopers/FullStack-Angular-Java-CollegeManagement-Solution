...
describe("TeacherService", () => {
  ...
  describe("functional", () => {
    ...
    it("should retrieve all teachers", () => {
      ...
      service.getAllTeachers().subscribe((response: any) => {
    ...
    it("should create a new teacher", () => {
      ...
      service.createTeacher(newTeacher).subscribe((response: any) => {
    ...
    it("should delete an existing teacher", () => {
      ...
      service.deleteTeacher(teacherId).subscribe((response: any) => {
    ...
    it("should search for teachers", () => {
      ...
      service.searchTeachersByName(searchTerm).subscribe((response: any) => {
